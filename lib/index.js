 ...
 *
 *      - Document: index.js
 *      - Author: aleen42, liziwl
 *      - Description: the main entrance for page-footer-liziwl
 *
 *
 **********************************************************************/
...
const pageFooter = module.exports = {
	...
	hooks: {
		'page:before': function (page) {
			 ...
			 * @type {Object}
			 */
			const configOption = this.config.get('pluginsConfig')['page-footer-liziwl'];

			/** if users have its option, and then combine it with default options */
			if (configOption) {
			// @deprecated
			// if (this.options.pluginsConfig['page-footer-liziwl']) {
				for (var item in defaultOption) {
					/** special for copyright */
					// @deprecated
					// defaultOption[item] = this.options.pluginsConfig['page-footer-liziwl'][item] || defaultOption[item];
			...
			const htmlContents = ' \n\n<footer class="footer">' +
				'<div class="footer__container--' + defaultOption.style + '" alt="' + uri + '">' +
					...
					'<div class="footer__description--' + defaultOption.style + '">' +
						'<p class="paragraph footer__author--' + defaultOption.style + '">' + defaultOption.signature + '</p>' +
						...
						'<div class="footer__main--' + defaultOption.style + '">' +
							'<div class="busuanzi-count">' +
								...
								'<script async="" src="//busuanzi.ibruce.info/busuanzi/2.3/busuanzi.pure.mini.js"></script>' +
									'<span class="page_pv" title="Page Visitors">' +
	...
	filters: {
		...
		currentUri: function (d, baseUri) {
			if (this.output.name == 'website') {
				return pageFooter.createQRcode(baseUri + this.output.toURL(d), 10, 'Q');
			} else {
				return '';
			}
		},
	...
	test: function (configs) {
		...
		const htmlContents = ' \n\n<footer class="footer">' +
			'<div class="footer__container--' + defaultOption.style + '" alt="' + uri + '">' +
				qrImg +
				'<div class="footer__description--' + defaultOption.style + '">' +
					'<p class="paragraph footer__author--' + defaultOption.style + '" style="color: #000 !important;">' + defaultOption.signature + '</p>' +
